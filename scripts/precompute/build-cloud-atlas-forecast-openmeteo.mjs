...
export async function buildCloudAtlasForecast(options = {}) {
  ...
  return publishCloudAtlasForecastArtifacts({
    ...
    source: {
      ...
      provenance:
        "Generated by scripts/precompute/build-cloud-atlas-forecast-openmeteo.mjs. Frames are visual-only cloud atlases intended for UTC-linear interpolation in the browser; sound-driving weather remains scanline-local.",
      frameProvenance:
        "Generated by scripts/precompute/build-cloud-atlas-forecast-openmeteo.mjs from Open-Meteo batch hourly cloud_cover requests. Source points are bilinearly resampled into the output atlas. This artifact is visual-only; sound-driving weather remains scanline-local.",
      manifestMetadata: {
