...
| Open-Meteo | Current cloud cover, humidity, wind, precipitation, temperature, and pressure for scanline-local cells | Live browser runtime with weather-cache fallback | Credit Open-Meteo. Weather data is used as local texture/filter input, not as forecast presentation. |
